      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-5 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5 border-b border-slate-100">
          <div>
            <h2 className="text-lg sm:text-xl font-bold text-slate-900 flex items-center gap-2">
              ...
              <span>Historial y Libro de Ingresos</span>
            </h2>
            <p className="text-xs text-slate-500 mt-0.5">
              Comprobantes y extractos procesados en esta sesión
            </p>
          </div>
          ...
          {historial.length > 0 && (
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                ...
                <span>Exportar Todo (Excel CSV)</span>
              </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-5">
          ...
          <div className="bg-slate-50/80 rounded-xl p-4 border border-slate-200/80">
            ...
            <span className="text-[11px] text-slate-500 mt-1 block">
              Comprobantes y extractos
            </span>
          </div>

          <div className="bg-slate-50/80 rounded-xl p-4 border border-slate-200/80">
            <span className="text-xs font-semibold text-slate-500 block mb-1">
              Total de Transferencias Acreditadas
            </span>
            <p className="text-xl sm:text-2xl font-black text-slate-900">
              {totalMovimientos}
            </p>
            <span className="text-[11px] text-slate-500 mt-1 block">
              Registros de movimientos individuales
            </span>
          </div>
        </div>
      </div>
